 ...
 */
contract CommunityBountyEscrow_BROKEN is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable,
    ReentrancyGuardUpgradeable
{
     ...
     */
    // NEGATIVE CONTROL: trailing CANCELLED member REMOVED - validateUpgrade MUST reject trailing-enum-member deletion (RC-2)
    enum BountyStatus { ACTIVE, COMPLETED, REFUNDED }
