...
contract DualCurrencyRepoRewards_BROKEN is Initializable, ContextUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 _injected; // NEGATIVE CONTROL: deliberate slot insertion BEFORE relayer - validateUpgrade MUST reject this layout shift
